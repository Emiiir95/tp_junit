...
class ArticleTest {
    ...
    void nomVideDoitLeverException() {
        assertThrows(IllegalArgumentException.class, () -> new Article("REF-001", "", 1.00));
    }

    @Test
    void prixNegatifAlaCreationDoitLeverException() {
        assertThrows(IllegalArgumentException.class, () -> new Article("REF-001", "Règle", -1.00));
    }
    ...
    void setPrixNegatifDoitLeverException() {
        ...
        assertThrows(IllegalArgumentException.class, () -> article.setPrix(-5.0));
    }
}